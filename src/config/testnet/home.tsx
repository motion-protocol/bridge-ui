    ...
    return (
      <AppLayout section="home">
        <div style={{ maxWidth: '500px' }}>
          ...
          <p>This is a gateway to access the Motion Protocol Testnet chain.</p>
          ...
          <ol style={{ marginInlineStart: '1.5em' }}>
            ...
            <li><a href="/wallet">Deposit</a> them to the chain. Your root chain coins (Rinkeby) will be locked in the Plasma contract and you will get an equivalent balance on the Motion network.</li>
